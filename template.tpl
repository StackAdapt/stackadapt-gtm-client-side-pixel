...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "StackAdapt Image-based Pixel (Client-Side)",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "StackAdapt client-side pixel allows the implementation of retargeting, conversion tracking, and lookalike targeting using a standalone image-based pixel",
  "containerContexts": [
    "WEB"
  ]
}
...
if (data.pixelType == 'conv'){
  paramType = "cid";
}

var dataUrl = "https://tags.srv.stackadapt.com/" + data.pixelType + "?" + paramType + "=" + data.pixelID + addCustomProperties(data.pixelType);
 
 

sendPixel(dataUrl, data.gtmOnSuccess, data.gtmOnFailure);
...
Created on 11/5/2025, 11:01:36 AM
